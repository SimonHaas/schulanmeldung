 ...
 */
final class Version20190225074648 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ausbildung (id INT AUTO_INCREMENT NOT NULL, beruf_id INT NOT NULL, betrieb_id INT NOT NULL, beginn DATE NOT NULL, ende DATE NOT NULL, INDEX IDX_E482F6FEDEF76C65 (beruf_id), INDEX IDX_E482F6FE587A3BD (betrieb_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE betriebedaten (id INT AUTO_INCREMENT NOT NULL, kammer_id INT NOT NULL, name VARCHAR(255) NOT NULL, anspr_partner VARCHAR(255) DEFAULT NULL, strasse VARCHAR(255) NOT NULL, hsnr VARCHAR(5) NOT NULL, plz VARCHAR(5) NOT NULL, ort VARCHAR(255) NOT NULL, tel_zentrale VARCHAR(255) NOT NULL, tel_durchwahl VARCHAR(255) DEFAULT NULL, fax VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, ist_verifiziert TINYINT(1) NOT NULL, gemeindeschluessel VARCHAR(8) NOT NULL, INDEX IDX_4FE64E847391165B (kammer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE schueler (id INT AUTO_INCREMENT NOT NULL, ausbildung_id INT DEFAULT NULL, fluechtling_id INT DEFAULT NULL, umschueler_id INT DEFAULT NULL, vorname VARCHAR(255) NOT NULL, nachname VARCHAR(255) NOT NULL, rufname VARCHAR(255) NOT NULL, geburtsdatum DATE NOT NULL, geburtsort VARCHAR(255) NOT NULL, geschlecht VARCHAR(1) NOT NULL, strasse VARCHAR(255) NOT NULL, hsnr VARCHAR(5) NOT NULL, plz VARCHAR(5) NOT NULL, ort VARCHAR(255) NOT NULL, tel VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, geburtsland VARCHAR(255) NOT NULL, staatsangehoerigkeit VARCHAR(255) NOT NULL, bekenntnis VARCHAR(255) NOT NULL, letzte_schulart VARCHAR(255) NOT NULL, hoechster_abschluss VARCHAR(255) NOT NULL, hoech_abschl_am DATE NOT NULL, UNIQUE INDEX UNIQ_C382476D984B3F39 (ausbildung_id), UNIQUE INDEX UNIQ_C382476D23E87371 (fluechtling_id), UNIQUE INDEX UNIQ_C382476DEF15F351 (umschueler_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kammer (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, kammernummer INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE registrierung (id INT AUTO_INCREMENT NOT NULL, schueler_id INT NOT NULL, datum DATETIME NOT NULL, mitteilung LONGTEXT DEFAULT NULL, wohnheim TINYINT(1) NOT NULL, eintritt_am DATE NOT NULL, ip VARCHAR(255) NOT NULL, typ VARCHAR(4) NOT NULL, ist_eqmassnahme TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_6E7E4FFD9AC0A64E (schueler_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE betriebedaten ADD CONSTRAINT FK_4FE64E847391165B FOREIGN KEY (kammer_id) REFERENCES kammer (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE betriebedaten DROP FOREIGN KEY FK_4FE64E847391165B');
